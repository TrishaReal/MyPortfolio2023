                ...
                <div className="works-col col-xs-12 col-sm-12 col-md-12 col-lg-12 sorting-development  ">
                  <div
                    ...
                    <div className="desc">
                      ...
                      <div className="text">
                        <p>
                          App where I got to use popular frontend libraries,
                          with a special emphasis on Redux. Other libraries
                          included Styled-system, Formik, and Yup.
                        </p>
                      </div>
                      <a
                        href="https://github.com/TrishaReal/PickMe-REDUX"
                    ...
                    <div className="desc">
                      ...
                      <div className="text">
                        <p>
                          ...
                          Page, and a Contact Page. Users can search for the
                          name of any existing cocktail and receive all the
                    ...
                    <div className="desc">
                      ...
                      <div className="text">
                        <p>
                          ...
                          theatrical performance on the International Day
                          against Violence towards Women, featuring Franca
                          Rame&apos;s powerful play, &ldquo;Lo Stupro.&rdquo;
                        </p>
                      </div>
                      <a
                        href="https://www.behance.net/gallery/139230679/Franca-Rame-Locandina-Evento"
                    ...
                    <div className="desc">
                      ...
                      <div className="text">
                        <p>
                          ...
                          Kundera&apos;s novel &ldquo;The Unbearable Lightness
                          of Being&rdquo;.
                        </p>
                      </div>
                      <a
                    ...
                    <div className="desc">
                      ...
                      <div className="text">
                        <p>
                          ...
                          it would be fitting to showcase Kobe Bryant as a way
                          to honor his memory following the heartbreaking news
                          in January 2020.
                        </p>
                      </div>
                      <a
                    ...
                    <div className="desc">
                      ...
                      <div className="text">
                        <p>
                          ...
                          from a color of their choice and easily copy it to
                          their clipboard with a simple click.
                        </p>
                      </div>
                      <a
                        href="https://myfirst-color-grading-website.netlify.app/"
                ...
                <div className="works-col col-xs-12 col-sm-12 col-md-12 col-lg-12 sorting-graphic  ">
                  <div
                    ...
                    <div className="desc">
                      ...
                      <div className="text">
                        <p>
                          Vanity Fair Cover: We had to choose a celebrity each
                          to portray, and I chose to depict the two faces of
                          Lady Gaga and create an idealized typical VF cover.
                        </p>
                      </div>
                      <a
                        href="https://www.behance.net/gallery/139230133/Vanity-Fair-Lady-Gaga"
                ...
                <div className="works-col col-xs-12 col-sm-12 col-md-12 col-lg-12 sorting-development  ">
                  <div
                    ...
                    <div className="desc">
                      ...
                      <div className="text">
                        <p>
                          One of the first personal projects I worked on was
                          this to-do list, using just Html, Css, and JavaScript
                          to put my knowledge into practice and starting
                          learning media queries to make the website responsive.
                        </p>
                      </div>
                      <a
                        href="https://my-first-to-do-list.netlify.app/"
                    ...
                    <div className="desc">
                      ...
                      <div className="text">
                        <p>
                          ...
                          practice, I embarked on the task of reproducing
                          Youtube Web.
                        </p>
                      </div>
                      <a
